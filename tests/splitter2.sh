...
# ----------------------------------------------------------------------------------
# Usage: ./splitter2.sh [DEV1] [DEV2] [DEV3]
#
...
VELEM1="v4l2src device=/dev/video1"
VCAPS1="image/jpeg,width=1280,height=960"
VSOURCE1="${VELEM1} ! ${VCAPS1}"
VSINK1="videorate ! image/jpeg,framerate=1/1 ! multifilesink location=cam1/image-%06d.jpg"

# source settings for camera 2 (standard UVC camera)
VELEM2="v4l2src device=/dev/video2"
